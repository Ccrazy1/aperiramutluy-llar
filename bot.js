...
client.on("ready", () => {//splashen
  client.user.setPresence({
    game: { name: `Alkatro Register V12 `, type: "WATCHING" },
    status: "online"
  });
});
...
if (tarih > 1296000000) kontrol = '<a:tik3:756946140825649214> Bu Kullanıcı **Güvenli**'
  ...
  let kanal1 = client.channels.cache.find(x => x.id === kanal);
    ...
    .setDescription(`
 » • <:new_partner_badge:781900500022853632> Hoşgeldin Alkatro Üyesi..  ${member}
 
 » • <a:pembeh:751553654561046619> Seninle birlikte ailemiz toplamda **${member.guild.memberCount}** kişi.
 
 » • [ **${ayarlar.tag}** ] Tagımızı alarak Ailemize katılabilirsin.
 ...
 » • <a:duyur:766652129678721074> Ses teyit odasına girerek teyitcilerin gelmesini bekleyin sonra kaydınız tamamlanacak . 
